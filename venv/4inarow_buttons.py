...
b0 = ard.get_pin("d:2:i").pin_number
b1 = ard.get_pin("d:3:i").pin_number
b2 = ard.get_pin("d:4:i").pin_number
b3 = ard.get_pin("d:5:i").pin_number
b4 = ard.get_pin("d:6:i").pin_number
b5 = ard.get_pin("d:7:i").pin_number
b6 = ard.get_pin("d:8:i").pin_number

buttons = [b0, b1, b2, b3, b4, b5, b6]

n1 = ard.get_pin("d:9:p").pin_number
